...
def loadcontext(object_type, uri, name=None, relative_to=None,
    ...
    print('add_conf_type(uri)',add_conf_type(uri))
...
class WSGIContext(object):
    ...
    def _app_call(self, env):
        ...
        """
	print('def _app_call in WSGIContext class start')
        self._response_status = None
        self._response_headers = None
        self._response_exc_info = None
	print('self.app = %s'%self.app)
	...
	print('resp = %s'%resp)
        ...
        if self._response_status is not None:
            return resp	
        resp = iter(resp)
	print('resp = %resp after iter '%resp)
	print('def _app_call in WSGIContext class end')
        try:
