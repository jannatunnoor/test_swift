...
class Application(object):
    ...
    def handle_request(self, req):
        ...
        """
	print 'in function handle request'
	print 'req',req
        try:
		...
		print 'req.environ[swift.authorize](req)',resp
	    ...
	    print 'handler,req',handler,req
	    print 'function handler req end, *** return handler(req)'
            return handler(req)
...
def app_factory(global_conf, **local_conf):
    ...
    print('*************app_factory start **************')
    conf = global_conf.copy()
    conf.update(local_conf)
    app = Application(conf)
    print('global_conf = %s , local_conf = %s , app = %s'%(global_conf,local_conf,app))
    app.check_config()
    print('*************app_factory end **************')
    return app
